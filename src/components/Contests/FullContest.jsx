...
import {Table, Header, Rating, Divider} from 'semantic-ui-react'

class FullContest extends React.Component {
  render() {
    return (<div>
      <br/>
      <h1>UDC Financía tu Proyecto - Contest Description</h1>
      <Divider/>
      <Table celled="celled" padded="padded">
        <Table.Header>
          ...
          <Table.Row>
            <Table.HeaderCell singleLine="singleLine">Evidence Rating</Table.HeaderCell>
